...
## Installation
1. Run `python3 build.py` from the repository root
2. Import the generated `.tgz` package from the `Build/` directory into your Unity project
3. Ensure Apple.Core is also installed (included as a dependency)
...
You can also provide purchase options:
```csharp
...
## Support
For issues, questions, or feedback, please visit the [main repository](../../../../../../README.md) or file an issue on GitHub.
